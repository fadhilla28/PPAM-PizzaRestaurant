package com.dilla.pizzarestaurant;
...
public class OrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu_button_order.setOnClickListener(v -> {
            ...
            String orderConfirm = "Terima kasih Pa/Bu " + nama + " sudah memesan ditoko cabang " + store +" kami, pesanan " + menu + " anda akan dikirim menggunakan " + Delivery;
